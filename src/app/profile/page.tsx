...
import SkeletonProfileHeader from "@/components/ui/SkeletonProfileHeader"
	...
	return (
		<div className="min-h-screen bg-[#0a0a0f]">
			...
			<div className="max-w-7xl mx-auto px-4 py-12">
				...
				{/* ==== Skeleton Header ==== */}
				{(userStats === undefined || !isLoaded) && <SkeletonProfileHeader />}
												...
												>
													<div className="p-6">
														...
														<div className="flex items-center justify-between text-sm text-gray-400">
															...
															<ChevronRight className="size-4 transform group-hover:translate-x-1 transition-transform" />
														</div>
													</div>
