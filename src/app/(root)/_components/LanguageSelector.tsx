...
const LanguageSelector = ({ hasAccess }: { hasAccess: boolean }) => {
	...
	// INFO: If the component is not mounted, show a skeleton button -- hydration error fix
	...
	return (
		<div className="relative" ref={dropdownRef}>
			...
			>
				...
				{/* ==== Language name ==== */}
				<span className="flex-1 text-gray-300 min-w-[80px] text-left group-hover:text-white transition-colors">
